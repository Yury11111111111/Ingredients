export default function SozdanieReligionOgranich() {
    return (
        <>
            <nav>
            ...
            <main>
                <div className="wrapper">
                        ...
                        <div className="choise-block">
                            ...
                            <div className="choise-block__ingredients ingredients-block">
                                ...
                                <div className="ingredients-block__category">
                                    ...
                                    <div className="ingredients-block__subblock subblock-category Ch">
                    ...
                    <div className="actions">
                        ...
                        <div className="actions__input-block">
                            <input type="checkbox" className="actions__checkbox" checked name="check_2" />
                            <div type="checkbox" className="checkbox__text">Светлое время суток</div>
                        </div >

                        <div className="actions__input-block" />
                        <input type="checkbox" className="actions__checkbox" checked name="check_2" />
                        <div type="checkbox" className="checkbox__text">Тёмное время суток</div>
                    </div >
                </div>
                <div>
