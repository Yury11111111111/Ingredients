export default function SozdanieOgranichPoIngred() {
    return(
        <>
        <nav>
        ...
        <div className="page-name">
            <span className="page-name__title">Новое ограничение</span>
        </div>
    </nav>
    <main>
        ...
        <form>
            ...
            <div className="food-restrictions">
                ...
                <div className="food-restrictions__title">Ограничения по ингредиентам</div>
            </div>
            <div className="prohibited-ingredients">
                <span className="prohibited-ingredients__ingredients">ИНГРЕДИЕНТ ИЛИ КАТЕГОРИЯ ИНГРЕДИЕНТОВ</span>
                <select name="username" className="prohibited-ingredients__choice">
                    <option value="title" className="prohibited-ingredients__point">Название ингредиента/категории</option>
                    <option value="1" className="prohibited-ingredients__point">Молоко</option>
                    <option value="2" className="prohibited-ingredients__point">Оливки</option>
                    <option value="3" className="prohibited-ingredients__point">Грибы</option>
                </select>
